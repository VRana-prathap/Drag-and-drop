...
- **Delete tasks** with a click on the × icon  
...
3. **Add tasks** in the "To Do" section using the input field  
4. **Drag tasks** between "To Do", "In Progress", and "Done"  
5. **Refresh or close** — your tasks stay saved!
